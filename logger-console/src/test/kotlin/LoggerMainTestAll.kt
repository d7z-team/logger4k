import org.d7z.logger4k.core.utils.withLogDebug
import org.d7z.logger4k.core.utils.withLogError
import org.d7z.logger4k.core.utils.withLogInfo
import org.d7z.logger4k.core.utils.withLogTrace
import org.d7z.logger4k.core.utils.withLogWarn
...
fun main() {
    ...
    // 获取Logger 实例
    val logger = org.d7z.logger4k.core.LoggerFactory.getLogger(LoggerMainTestAll::class)
    // 另一种方式获取Logger 实例
    System.setProperty("logger.level", "[*=trace]")
    logger.trace("trace.")
    ...
    // 输出 ERROR 日志
    val logger2 = org.d7z.logger4k.core.LoggerFactory.getLogger(Void::class)
