...
import org.d7z.logger4k.core.internal.simple.format.LoggerMessageFormat
...
abstract class AbstractLogger : ILogger {
    ...
    override fun trace(message: String, vararg param: Any?): ILogger {
        ...
        output(
            ...
            LoggerLevel.TRACE, LoggerMessageFormat.format(message, array)
        )
        return this
    }
    ...
    override fun debug(message: String, vararg param: Any?): ILogger {
        ...
        output(
            name, Thread.currentThread(), LocalDateTime.now(),
            LoggerLevel.DEBUG, LoggerMessageFormat.format(message, array)
        )
        return this
    }
    ...
    override fun info(message: String, vararg param: Any?): ILogger {
        ...
        output(
            name, Thread.currentThread(), LocalDateTime.now(),
            LoggerLevel.INFO, LoggerMessageFormat.format(message, array)
        )
        return this
    }
    ...
    override fun warn(message: String, vararg param: Any?): ILogger {
        ...
        output(
            name, Thread.currentThread(), LocalDateTime.now(),
            LoggerLevel.WARN, LoggerMessageFormat.format(message, array)
        )
        return this
    }
    ...
    override fun error(message: String, vararg param: Any?): ILogger {
        ...
        output(
            name, Thread.currentThread(), LocalDateTime.now(),
            LoggerLevel.ERROR, LoggerMessageFormat.format(message, array)
        )
        return this
    }
